...
public class ObjectFactory {
    ...
    private final static QName _ExtendLoan_QNAME = new QName("http://com/", "extendLoan");
    ...
    private final static QName _GetUser_QNAME = new QName("http://com/", "getUser");
    ...
    private final static QName _GetUserResponse_QNAME = new QName("http://com/", "getUserResponse");
    ...
    private final static QName _ExtendLoanResponse_QNAME = new QName("http://com/", "extendLoanResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "extendLoan")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "getUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "getUserResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "extendLoanResponse")
