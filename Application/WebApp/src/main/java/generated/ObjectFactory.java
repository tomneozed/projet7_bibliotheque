...
public class ObjectFactory {
    ...
    private final static QName _AllPretsResponse_QNAME = new QName("http://com/", "allPretsResponse");
    private final static QName _UpdateAuteur_QNAME = new QName("http://com/", "updateAuteur");
    private final static QName _GetPret_QNAME = new QName("http://com/", "getPret");
    ...
    private final static QName _AllPrets_QNAME = new QName("http://com/", "allPrets");
    ...
    private final static QName _GetPretResponse_QNAME = new QName("http://com/", "getPretResponse");
    ...
    /**
     * Create an instance of {@link GetPretResponse }
     * 
     */
    public GetPretResponse createGetPretResponse() {
        return new GetPretResponse();
    }
    ...
    /**
     * Create an instance of {@link AllPrets }
     * 
     */
    public AllPrets createAllPrets() {
        return new AllPrets();
    }
    ...
    /**
     * Create an instance of {@link GetPret }
     * 
     */
    public GetPret createGetPret() {
        return new GetPret();
    }
    ...
    /**
     * Create an instance of {@link AllPretsResponse }
     * 
     */
    public AllPretsResponse createAllPretsResponse() {
        return new AllPretsResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AllPretsResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "allPretsResponse")
    public JAXBElement<AllPretsResponse> createAllPretsResponse(AllPretsResponse value) {
        return new JAXBElement<AllPretsResponse>(_AllPretsResponse_QNAME, AllPretsResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetPret }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "getPret")
    public JAXBElement<GetPret> createGetPret(GetPret value) {
        return new JAXBElement<GetPret>(_GetPret_QNAME, GetPret.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AllPrets }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "allPrets")
    public JAXBElement<AllPrets> createAllPrets(AllPrets value) {
        return new JAXBElement<AllPrets>(_AllPrets_QNAME, AllPrets.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetPretResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://com/", name = "getPretResponse")
    public JAXBElement<GetPretResponse> createGetPretResponse(GetPretResponse value) {
        return new JAXBElement<GetPretResponse>(_GetPretResponse_QNAME, GetPretResponse.class, null, value);
    }
